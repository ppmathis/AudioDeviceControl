========================================================================
    KONSOLENANWENDUNG: AudioDeviceControl-Projektübersicht
========================================================================

Diese AudioDeviceControl-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre AudioDeviceControl-Anwendung besteht.


AudioDeviceControl.vcxproj
...
AudioDeviceControl.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen AudioDeviceControl.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
